package freeman.buyn.adressappfx;

import static freeman.buyn.adressappfx.util.DebugMsg.debugInfo;
import static freeman.buyn.adressappfx.util.DebugMsg.debugLog;
import java.io.File;
import java.io.IOException;
import java.util.prefs.Preferences;
import freeman.buyn.adressappfx.model.FXmlControler;
import freeman.buyn.adressappfx.model.JAXBWrapper;
import freeman.buyn.adressappfx.model.Person;
import freeman.buyn.adressappfx.view.BirthdayStatisticsController;
import freeman.buyn.adressappfx.view.EditPersonDialogController;
import freeman.buyn.adressappfx.view.PersonOverviewController;
import freeman.buyn.adressappfx.view.RootLayoutController;
...
public class MainApp extends Application {
	public static final String TITLE = "AddressApp";
	 ...
	 */
	public MainApp() {
		freeman.buyn.adressappfx.util.DebugMsg.setDebugMode(DEBUGMODE);
	...
	public void start(Stage primaryStage) {
		...
		initRootLayout();
		showPersonOverview();
		debugLog("getPersonFilePath = " + getPersonFilePath());
		debugInfo("Main fxm's loaded");  
		if (getPersonFilePath() != null) {
			debugInfo("path auto " + getPersonFilePath().getPath());
			JAXBWrapper listWrapper = new JAXBWrapper(getPersonData());
			listWrapper.loadPersonDataFromFile(getPersonFilePath());	
		}
	}
	/*
